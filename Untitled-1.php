...
$inputJSON = '{"EmployeeID":"3509","SerialNo":"6728322120001025","AttendanceDate":"2026-04-02","PunchTime":"2026-04-02T06:30:00"}';
//$inputJSON = '{"EmployeeID":"2348","SerialNo":"6728322120001025","AttendanceDate":"2026-04-01","PunchTime":"2026-04-01T22:08:35"}';
//$inputJSON = '{"EmployeeID":"3509","SerialNo":"6728322120001025","AttendanceDate":"2026-04-05","PunchTime":"2026-04-05T06:20:35"}';
...
LIMIT 1;";
			...
			if ($emp_id > 0) {
				...
				$attendence_data = $obj->select_record("attendance_entry", ["attendance_id" => $attendance_id]);
				$att_shift_id = $attendence_data['shift_id'] ?? $shift_id;
				$intime = $attendence_data['intime'] ?? '';
				//$last_out_entry = $attendence_data['outtime'] ?? '';
				...
				$last_out_entry = $obj->getvalfield("attendance_entry", "outtime", "attendance_id='$last_entry_id'");
