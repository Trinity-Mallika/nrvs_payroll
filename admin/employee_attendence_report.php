                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="employee_wise_attendance.php?emp_id=<?= $emp_id ?>&month=<?= $currentMonth ?>&year=<?= $currentYear ?>&date=<?= $attendance_date ?>">
                                                                <span class="badge bg-<?= $badge ?> fs-11"><?= $status ?></span></a>
                                                        </td>
