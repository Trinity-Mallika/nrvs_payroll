...
if (isset($_POST['submit'])) {
    ...
    if ($if_exist > 0) {
        $emp_code =  $emp_code = $obj->getcode("employee_master", "emp_code",  "unit_id='$unitid'");
    }
    ...
    $count = $obj->getvalfield($tblname, "count(*)", "(biomatric_id = '$biomatric_id' OR emp_code = '$emp_code' OR mobile_no = '$mobile_no') and $tblpkey!='$keyvalue'");
...
if (isset($_GET[$tblpkey])) {
    ...
    $first_name = $last_name = $father_name = $biomatric_id = $gender = $dob = $age = $blood_group = $marital_status = $nationality = $religion = $caste = $mobile_no = $alt_mobile_no = $email_id = $present_address = $permanent_address = $emer_contact_name = $emer_contact_relation = $emer_contact_no = $aadhar_no = $pan_no = $driving_license = $passport_no = $identification_masks = $department_id = $designation_id = $grade_id = $date_of_joining = $job_location = $shift_id = $employee_type = $reporting_manager = $employer_name = $employer_designation_id = $service_from = $service_to = $reason = $job_responsibility = $last_salary = $profile_image = $basic_salary = $opening_balance = $opening_date = $hra = $da = $conveyance = $medical_allowance = $special_allowance = $is_pf = $is_esic = $is_pt = $is_lwf = $ctc = $gross_salary = $net_salary =  $pf_uan = $uan_no = $esic_no = $pf_joining_date = $esic_joining_date = $document_ids = $form21_last_date = '';
                                    ...
                                    <div class="step-arrow-nav">
                                            ...
                                            <div class="row g-3">
                                                <div class="col-md-3">
                                                    ...
                                                    <input type="text" class="form-control form-control-sm"
                                                        name="emp_code" id="emp_code" placeholder="Enter Code" value="<?= $emp_code ?>" readonly>
                                                </div>
                                        ...
                                        <div class="form-step">
                                            ...
                                            <div class="mt-4 d-flex justify-content-between">
                                                <button type="button" class="btn btn-secondary btn-prev">←
                                                    Previous</button>
                                                <button type="button" class="btn btn-primary btn-next" data-validate="basic_salary,department_id,designation_id,grade_id,date_of_joining,job_location,shift_id">Next
                                                    →</button>
