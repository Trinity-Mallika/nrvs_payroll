...
<body>
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="mb-3 col-12 col-lg-5">
                                                ...
                                                <select class="form-select form-select-sm chosen-select" name="emp_id" id="emp_id" onchange="getUrl(this.value);">
    ...
    <!-- Modal -->
    <div class="modal fade" id="timepicker" tabindex="-1" aria-labelledby="timepickerLabel" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
                    ...
                    <div class="row">
                        <div class="col-lg-12 mb-5 ">
                            ...
                            <div class="col-lg-12 mt-2" id="shiftBox">
                                <label for="punch_shift_id" class="form-label ">Shift<span
                                        class="text-danger fw-bold"> </span></label>
                                <select class="form-select form-select-sm chosen-select"
                                    name="punch_shift_id" id="punch_shift_id">
                        ...
                        <div class="col-lg-12 ">
                            <center>
                                <input type="button" class="btn btn-success btn-sm" value="Punch In" onclick="punchinout()" id="punchinbutton">
                            </center>
                        </div>
                    </div>
                </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" id="savebutton" onclick="savePunch()">Save changes</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        function getUrl(id) {
            ...
            location = "employee_wise_attendance.php?emp_id=" + id + "&currentYear=" + currentYear + "&currentMonth=" + currentMonth;
        };
