...
$title = "Management Page Privellege";
$pagename = "mngmt_page_privilege.php";
$module = "Management Page Privellege";
$submodule = "Management Page Privellege";
$btn_name = "Save";
$keyvalue = 0;
...
if (isset($_POST['submit'])) {
    ...
    $count = $obj->getvalfield($tblname, "count(*)", "pagelink='$pagelink' and type='mngmt' and $tblpkey !='$keyvalue'");
    if ($count == 0) {
        if ($keyvalue == 0) {
            //insert
            $form_data = array(
                                ...
                                <div class="table-responsive">
                                    <table id="buttons-datatables" class="display table table-sm table-bordered" style="width:100%">
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            $slno = 1;
                                            $res = $obj->executequery("select * from $tblname where type='mngmt' order by $tblpkey desc");
                                                    ...
                                                    <td>
                                                        <ul class="list-inline hstack gap-2 mb-0">
                                                            <li class="list-inline-item " data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Edit">
                                                                <a href="<?php echo $pagename ?>?<?php echo $tblpkey ?>=<?php echo $row_get[$tblpkey]; ?>" class="edit-item-btn"><i class="ri-pencil-fill align-bottom text-success"></i></a>
                                                            </li>
                                                            <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Delete">
                                                                <a class="remove-item-btn" type="button" onclick="funDel(<?php echo $row_get[$tblpkey]; ?>);">
