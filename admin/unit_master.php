...
$btn_name = "Save";
$imgpath = '../management/uploaded/emp_documents/';
$imgpath1 = '../management/uploaded/emp_documents/';
$keyvalue = $unitid;
        ...
        if ($keyvalue == 0) {
            if (isset($_FILES["logo_image"]) && !empty($_FILES["logo_image"]['name'])) {
                ...
                if (in_array($imageFileType, $allowedTypes)) {
                    $logo_image = $obj->uploadImage($imgpath1, $_FILES["logo_image"]);
            ...
            if (!empty($imageName) && in_array($imageFileType, $allowedTypes)) {
                $old = $obj->getvalfield($tblname, "logo_image", "unit_id='$keyvalue'");
                if (!empty($old)) {
                    @unlink($imgpath1 . $old);
                }
                                    ...
                                    <div class="row">
                                        <div class="col-lg-3 mb-3">
                                            ...
                                            <input type="text" id="unit_name" name="unit_name"
                                                class="form-control form-control-sm" placeholder="Enter Unit Name"
                                                value="<?php echo $unit_name ?>" autocomplete="off" />
                                        </div>
                                        <div class="col-lg-3 mb-3">
                                            <label for="unit_name" class="form-label">Head Name<span
                                                    class="text-danger fw-bold">*</span></label>
                                            <input type="text" id="unithead" name="unithead"
                                                class="form-control form-control-sm" placeholder="Enter Head Name"
                                                value="<?php echo $unithead ?>" autocomplete="off" />
                                        </div>
                                        <div class="col-lg-3 mb-3">
                                            <label for="unit_name" class="form-label">Contact No.<span
                                                    class="text-danger fw-bold">*</span></label>
                                            <input type="text" id="mobile" name="mobile"
                                                class="form-control form-control-sm" maxlength="10"
                                                placeholder="Enter Contact No." value="<?php echo $mobile ?>"
                                                autocomplete="off" onkeypress="numberOnly(event);" maxlength="10" />
                                        </div>
                                        <div class="col-lg-3 mb-3">
                                            <label for="pan_no" class="form-label">Email-Id<span
                                                    class="text-danger fw-bold"></span></label>
                                            <input type="email" id="email_id" name="email_id"
                                                class="form-control form-control-sm" placeholder="Enter Email-Id"
                                                value="<?php echo $email_id ?>" autocomplete="off" />
                                        </div>
                                        <div class="col-lg-3 mb-3">
                                            ...
                                            <input type="text" id="pan_no" name="pan_no"
                                                class="form-control form-control-sm" maxlength="10"
                                                placeholder="Enter Pan No." value="<?php echo $pan_no ?>"
                                                autocomplete="off" />
                                        </div>
                                        <div class="col-lg-3 mb-3">
                                            <label for="gstin_no" class="form-label">GSTIN No.<span
                                                    class="text-danger fw-bold"></span></label>
                                            <input type="text" id="gstin_no" name="gstin_no"
                                                class="form-control form-control-sm" placeholder="Enter GSTIN No."
                                                value="<?php echo $gstin_no ?>" autocomplete="off" />
                                        </div>

                                        <div class="col-lg-3 mb-3">
                                            <label for="cin_no" class="form-label">CIN No.<span
                                                    class="text-danger fw-bold"></span></label>
                                            <input type="text" id="cin_no" name="cin_no"
                                                class="form-control form-control-sm" placeholder="Enter cin No."
                                                value="<?php echo $cin_no ?>" autocomplete="off" />
                                        </div>
                                        <div class="col-lg-3 mb-3">
                                            ...
                                            <input type="text" id="city" name="city"
                                                ...
                                                value="<?php echo $city ?>" autocomplete="off" />
                                        </div>
                                        <div class="col-md-3">
                                            <label class="form-label">Unit Logo<span
                                                    class="text-danger fw-bold">*</span></label>
                                            <input type="file" class="form-control form-control-sm" name="logo_image"
                                                id="logo_image" value="<?= $logo_image ?>" accept="image/*">
                                            <?php if ($logo_image != "") {
                                            ?>
                                            <img src="<?php echo $imgpath1 . $logo_image;  ?>" style="height: 50px;"
                                                alt="">
                                            <?php
                                            } ?>
                                        </div>
                                        <div class="col-md-3">
                                            <label class="form-label">Watermark Image <span
                                                    class="text-danger fw-bold">*</span></label>
                                            <input type="file" class="form-control form-control-sm" name="watermark"
                                                id="watermark" accept="image/*">
                                            <?php if (!empty($watermark)) {
                                            ?>
                                            <img src="<?php echo $imgpath1 . $watermark; ?>" style="height: 50px;"
                                                alt="">
                                            <?php
                                            } ?>
                                        </div>
                                        <div class="col-lg-3 mb-3">
                                            <label for="address" class="form-label"> Unit Address<span
                                                    class="text-danger fw-bold">*</span></label>
                                            <textarea name="address" id="address"
                                                class="form-control form-control-sm"><?php echo $address ?></textarea>

                                        </div>
                                        <div class="col-lg-3 mb-3">
                                            <label for="work_address" class="form-label"> Work Address<span
                                                    class="text-danger fw-bold">*</span></label>
                                            <textarea name="work_address" id="work_address"
                                                class="form-control form-control-sm"><?php echo $work_address ?></textarea>

                                        </div>
                                        <div class="col-md-3">
                                            <label class="form-label d-block">Allow Leave in Attendance?</label>

                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="add_leave"
                                                    id="add_leave_yes" value="1"
                                                    <?= $add_leave == '1' ? 'checked' : '' ?>>
                                                <label class="form-check-label" for="add_leave_yes">Yes</label>
                                            </div>

                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="add_leave"
                                                    id="add_leave_no" value="0"
                                                    <?= $add_leave == '0' ? 'checked' : '' ?>>
                                                <label class="form-check-label" for="add_leave_no">No</label>
                                            </div>
                                        </div>
                                        <div class="col-lg-3 mb-3">
                                            <label for="machine_id" class="form-label">Machine Id<span
                                                    class="text-danger fw-bold"></span></label>
                                            <input type="text" id="machine_id" name="machine_id"
                                                class="form-control form-control-sm" placeholder="Enter Machine id"
                                                value="<?php echo $machine_id ?>" autocomplete="off"
                                        ...
                                        <div class="col-lg-4 mb-3">
                                            ...
                                            <input type="submit" name="submit" class="btn btn-sm btn-primary add-btn"
                                                ...
                                                onClick="return checkinputmaster('unit_name,unithead,mobile,city,<?= $img ?>,watermark,address,work_address');" />
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="<?= $imgpath1 . $row['logo_image'] ?>" target="_blank"
                                                ...
                                                <td>
                                                    ...
                                                    <a href="<?= $imgpath1 . $row['watermark'] ?>" target="_blank"
                                                        class="btn btn-sm btn-primary">
                                                        View
                                                    </a>
                                                    <?php } ?>
