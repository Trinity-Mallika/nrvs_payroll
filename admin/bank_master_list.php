...
$pagename = "bank_master_list.php";
$pagename2 = "bank_master.php";
$title = "Bank MASTER";
$tblname = "bank_master";
$tblpkey = "bank_id";
$module = "Bank Master";
                            ...
                            <div class="card" id="customerList">
                                <div class="card-header border-bottom-dashed">
                                    <div class="row g-4 align-items-center">
                                        <div class="col-sm">
                                            <div>
                                                <h5 class="card-title mb-0"> <?= $submodule; ?><a href="bank_master.php" class="float-end btn btn-primary btn-sm">Add Bank</a></h5>
                                            </div>
                                        </div>
                                    </div>
