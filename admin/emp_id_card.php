    ...
    <td colspan="3" align="center">
        ...
        ">
            <tr>
                ...
                ">
                    <img src="'.$photo.'" width="45mm" height="45mm">
                </td>
            </tr>
        </table>
        ...
        <td>
            ...
            <table class="details">
                ...
                <tr>
                    ...
                    <td class="label"> <img src="'.$user_pic.'" width="10" height="10">
        &nbsp;NAME</td>
                    <td class="colon">:</td>
                ...
                <tr>
                    <td class="label"><img src="'.$f_pic.'" width="10" height="10">
        &nbsp;F/H NAME</td>
                    <td class="colon">:</td>
                ...
                <tr>
                    <td class="label"><img src="'.$code_pic.'" width="10" height="10">
        &nbsp;E.CODE</td>
                    <td class="colon">:</td>
                ...
                <tr>
                    <td class="label"><img src="'.$blood_pic.'" width="10" height="10">
        &nbsp;BLOOD GROUP</td>
                    <td class="colon">:</td>
                ...
                <tr>
                    <td class="label"><img src="'.$position_pic.'" width="10" height="10">
        &nbsp;DESIGNATION</td>
                    <td class="colon">:</td>
                ...
                <tr>
                    <td class="label"><img src="'.$suitcase_pic.'" width="10" height="10">
        &nbsp;DEPARTMENT</td>
                    <td class="colon">:</td>
                ...
                <table cellpadding="0" cellspacing="0">
                    <tr>
                        ...
                        <td style="padding-left:4px; text-align:left;">
                            ...
                            <div style="font-size:10px; line-height:10px;color:white;">
                                MOBILE
                            </div>
