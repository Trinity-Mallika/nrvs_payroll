...
<body>
                                ...
                                <div class="card-body">
                                    <form method="post" id="salaryForm">
                                        <div class="row">
                                            ...
                                            <!-- <div class="col-lg-2 col-12 mb-3">
                                                <label for="">PF Paid Basic</label>
                                                <input type="text" class="form-control form-control-sm" value="<?= $pf_esic_basic ?>" name="pf_esic_basic" id="pf_paid_basic">
                                            </div>
                                            <div class="col-lg-2 col-12 mb-3">
                                                <label for=""> ESIC Paid Basic</label>
                                                <input type="text" class="form-control form-control-sm" value="<?= $pf_esic_basic ?>" name="pf_esic_basic" id="esic_paid_basic">
                                            </div> -->
                                            <div class="col-lg-2 col-12 mb-3">
    ...
    <script>
        function calculateForm() {
            ...
            if (is_pf == 1) {
                pf_val = round(basicDA * slab.pf_per / 100);
                pf_emp_val = round(basicDA * slab.pf_emp_per / 100);
            }
            if (is_esic == 1) {
...
<body>
        ...
        function calculateForm() {
            ...
            if (is_pf == 1) {
                if (totalRevisedSalary > 15000) {
                    ...
                    //  pf_paid_basic_val = round(pf_rate_val / totalDaysInMonth * pf_days);
            ...
            // if (is_esic == '1') {
            //     // if (basicRate <= 21000) {
            //     if (total_payable_amt > 21000) {

            //         esic_paid_basic_val = 21000;
            //     } else {
            //         esic_paid_basic_val = total_payable_amt;
            //     }

            //     // esic_val = round(basicDA * slab.esic_per / 100);
            //     // esic_emp_val = round(basicDA * slab.esic_emp_per / 100);

            //     esic_val = round(esic_paid_basic_val * slab.esic_per / 100);
    ...
    <script>
        function totalWorking() {
            ...
            let baseTotal = presentDays + holidays + weeklyOff + leaveDays + advance_leave + overtime_days;
