                                            ...
                                            <div class="card shadow-sm border-0">
                                                ...
                                                <div class="card-body p-3">
                                                    ...
                                                    <div class="d-flex justify-content-between border-bottom py-2">
                                                        ...
                                                        <span class="fw-bold">
                                                            ₹ <?= number_format($sum['approved_advance'],2) ?>
                                                        </span>
                                                    </div>
                                                    ...
                                                    <div class="d-flex justify-content-between border-bottom py-2">
                                                        ...
                                                        <span class="fw-bold">
                                                            ₹ <?= number_format($sum['pending_advance'],2) ?>
                                                        </span>
                                                    </div>
                                                    ...
                                                    <div class="d-flex justify-content-between border-bottom py-2">
                                                        ...
                                                        <span class="fw-bold">
                                                            ₹ <?= number_format($sum['approved_loan'],2) ?>
                                                        </span>
                                                    </div>
                                                    ...
                                                    <div class="d-flex justify-content-between py-2">
                                                        ...
                                                        <span class="fw-bold">
                                                            ₹ <?= number_format($sum['pending_loan'],2) ?>
                                                        </span>
                                                    </div>

                                                    <div class="d-flex justify-content-between py-2">
                                                        <span class="fw-semibold text-danger">
                                                           This Month duduction Amount
                                                        </span>
                                                        <span class="fw-bold">
                                                            ₹ <?= number_format($sum['pending_loan'],2) ?>
                                                        </span>
