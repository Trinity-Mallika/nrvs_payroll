                            ...
                            <div class="card" id="customerList">
                                <div class="card-header border-bottom-dashed">
                                    <div class="row g-4 align-items-center">
                                        <div class="col-sm">
                                            <div>
                                                <h5 class="card-title mb-0"> <?= $module; ?>  <a href="show_loan_details.php" class="float-end btn btn-sm btn-primary">Show Loan/Advance Details</a></h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card">
                                <div class="card-header border-bottom-dashed">
                                    <div class="row g-4 align-items-center">
                                        <div class="col-sm">
                                            <div>
                                                <h5 class="card-title mb-0"> <?= $module; ?> <a href="loan_advance_report.php"
                                                        class="float-end btn btn-sm btn-primary ms-2">Search Again</a><a href="show_loan_details.php" class="float-end btn btn-sm btn-primary">Show Loan/Advance Details</a> </h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    ">
                                                            ...
                                                            <td>
                                                                <a href="loan_adv_summarypdf.php?<?php echo $tblpkey ?>=<?php echo $row[$tblpkey]; ?>"
                                                                    ...
                                                                    <i
                                                                        class="ri-printer-fill cursor-pointer text-primary fs-4">
                                                                    </i>
                                                                </a>
                                                            </td>
                                                        </tr>
