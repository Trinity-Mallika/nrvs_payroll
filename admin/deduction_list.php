                            ...
                            <div class="card" id="customerList">
                                <div class="card-header border-bottom-dashed">
                                    <div class="row g-4 align-items-center">
                                        <div class="col-sm">
                                            <div>
                                                <h5 class="card-title mb-0"> <?= $module; ?> <a href="deduction_entry.php" class="float-end btn btn-primary btn-sm">Add New</a></h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card" id="customerList">
                                <div class="card-header border-bottom-dashed">
                                    <div class="row g-4 align-items-center">
                                        <div class="col-sm">
                                            <div>
                                                <h5 class="card-title mb-0"> <?= $module; ?> <a href="deduction_list.php"
                                                    class="float-end btn btn-sm btn-primary ms-2">Search Again</a> <a
                                                    href="deduction_entry.php"
