...
$pagename = "manual_emp_report.php";
$title = "Manual Employee Report";
$tblname = "employee_master";
$tblpkey = "emp_id";
$module = "Manual Employee Report";
$submodule = "Manual Employee Report";
$btn_name = "Save";
