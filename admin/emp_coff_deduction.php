...
$pagename = "emp_coff_deduction.php";
$title = "Employee C-Off Deduction";
$module = "Employee C-Off Deduction";
$submodule = "Employee C-Off Deduction";
$btn_name = "Save";
$keyvalue = 0;
...
<body>
                                    ...
                                    <div class="col-sm">
                                        <div>
                                            <h5 class="card-title mb-0"><?= $module ?> <a href="<?= $pagename ?>"
                                                    ...
                                                    href="leave_deduction_report.php"
                                                    class="float-end btn btn-primary btn-sm ms-4">Report</a></h5>
                                        </div>
                                        ...
                                        <table id="buttons-datatables" class="display table table-sm table-bordered"
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="text"
                                                            class="form-control form-control-sm w-50 c_off"
                                                            id="c_off<?= $row['emp_id'] ?>"
                                                            value="<?= $prev_coff ?>" readonly>
                                                    </td>
                                                    <td>
                                                        <input type="text"
    ...
    function calculateLeave(emp_id) {
        var earning = parseFloat($("#c_off" + emp_id).val()) || 0;
