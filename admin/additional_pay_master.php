            ...
            if ($xlsx = SimpleXLSX::parse($_FILES['file_upload']['tmp_name'])) {
                foreach ($xlsx->rows() as $k => $data) {
                    ...
                    $count = $obj->getvalfield(
                        $tblname,
                        "count(*)",
                        "emp_id='$emp_id' AND month='$file_month' AND year='$file_year' AND unit_id='$unitid'"
                    );
...
<body>
                                        ...
                                        <div class="col-sm">
                                            <div>
                                                <h5 class="card-title mb-0"> Employee Details
                                                    <a href="additional_pay_list.php"
                                                        class="float-end btn btn-primary btn-sm">List</a>
                                                </h5>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-lg-6 mb-3">
                                            <label for="emp_id" class="form-label">Rembursment<span
                                        ...
                                        <div class="col-lg-6 mb-3">
                                            <label for="basic_arear" class="form-label">Arear <span class="text-danger"
                                                    id="net_payment"></span></label>
                                            <input type="text" id="basic_arear" name="basic_arear"
                                                class="form-control form-control-sm" placeholder="Enter Arear"
                                                value="<?= $basic_arear ?>" autocomplete="off"
                                                onkeypress="numberOnly(event);" />
                                        </div>
                                        <div class="col-lg-6 mb-3">
                                            <label for="other_reimbursement" class="form-label">Other Reimbursement
                                                <span class="text-danger" id="net_payment"></span></label>
                                            <input type="text" id="other_reimbursement" name="other_reimbursement"
                                                class="form-control form-control-sm"
                                                placeholder="Enter Other Reimbursement"
                                                value="<?= $other_reimbursement ?>" autocomplete="off"
                                                onkeypress="numberOnly(event);" />
                                        </div>
                                        <div class="col-lg-6 mb-3">
                                            <label for="increment_arear" class="form-label">Increment Arear <span
                                                    class="text-danger" id="net_payment"></span></label>
                                            <input type="text" id="increment_arear" name="increment_arear"
                                                class="form-control form-control-sm" placeholder="Enter Increment Arear"
                                                value="<?= $increment_arear ?>" autocomplete="off"
                                                onkeypress="numberOnly(event);" />
                                        </div>
                                        <div class="col-lg-6 mb-3">
                                            <label for="bonus" class="form-label">Bonus <span class="text-danger"
                                                    id="net_payment"></span></label>
                                            <input type="text" id="bonus" name="bonus"
                                                class="form-control form-control-sm" placeholder="Enter Bonus"
                                                value="<?= $bonus ?>" autocomplete="off"
                                                onkeypress="numberOnly(event);" />
                                        </div>
                                        <div class="col-lg-6 mb-3">
                                            <label for="leave_encasement" class="form-label">Leave encasement <span
                                                    class="text-danger" id="net_payment"></span></label>
                                            <input type="text" id="leave_encasement" name="leave_encasement"
                                                class="form-control form-control-sm"
                                                placeholder="Enter Leave encasement" value="<?= $leave_encasement ?>"
                                                autocomplete="off" onkeypress="numberOnly(event);" />
                                        </div>
                                        <div class="col-lg-6 mb-3">
                                            <label for="notice_period" class="form-label">Notice period <span
                                                    class="text-danger" id="net_payment"></span></label>
                                            <input type="text" id="notice_period" name="notice_period"
                                                class="form-control form-control-sm" placeholder="Enter Notice period"
                                                value="<?= $notice_period ?>" autocomplete="off"
                                                onkeypress="numberOnly(event);" />
                                        </div>
                                        <div class="col-lg-6 mb-3">
                                            <label for="total_additional_payment" class="form-label">Total Additional
                                                Payment <span class="text-danger" id="net_payment"></span></label>
                                            <input type="text" id="total_additional_payment"
                                                name="total_additional_payment" class="form-control form-control-sm"
                                                placeholder="Enter Total Additional Payment"
                                                value="<?= $total_additional_payment ?>" autocomplete="off"
                                                onkeypress="numberOnly(event);" readonly />
                                        </div>
                                        <div class="col-lg-6 mb-3">
                                            <label for="remark" class="form-label">Remark <span class="text-danger"
                                                    id="net_payment">*</span></label>
                                            <textarea id="remark" name="remark" class="form-control form-control-sm"
                                                placeholder="Enter Remark" autocomplete="off"><?= $remark ?></textarea>
                                        </div>
                                        ...
                                        <div class="col-lg-4 mb-3">
                                            ...
                                            <input type="submit" name="submit" class="btn btn-sm btn-primary add-btn"
                                                ...
                                                onClick="return checkinputmaster('emp_id,month,remark')">
                            ...
                            <div class="card" id="customerList">
                                <div class="card-header border-bottom-dashed">
                                    <div class="row g-4 align-items-center">
                                        <div class="col-sm">
                                            <div>
                                                <h5 class="card-title mb-0">File Upload <a
                                                        href="additional_payment.xlsx"
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-lg-6 mb-3">
                                            <label for="month" class="form-label">Month<span
                                                    class="text-danger fw-bold">*</span></label>
                                            <select class="form-select form-select-sm chosen-select" name="file_month"
                                                id="file_month">
                                                <option value="">Select</option>
                                                <?php
                                                $months = [
                                        ...
                                        <div class="col-lg-6 mb-3">
                                            <label for="year" class="form-label">Year<span
                                                    class="text-danger fw-bold">*</span></label>
                                            <select class="form-select form-select-sm chosen-select" name="file_year"
                                                id="file_year">
                                                <option value="">Select</option>
                                                <?php
                                                $startYear = 2025;
                                        ...
                                        <div class="col-lg-4 mb-3">
                                            ...
                                            <input type="submit" name="upload_excel"
                                                ...
                                                onClick="return checkinputmaster('file_month,file_year,file_upload')">
                                        </div>
                                        <?php } ?>
                                        ...
                                        <div class="col-lg-12 mt-3">
                                            <div class="alert alert-info mb-0">
                                                <h6 class="mb-2"><i class="ri-information-line"></i> Excel Upload
                                                    Summary</h6>
    ...
    $(document).on('input',
        '#basic_arear,#other_reimbursement,#increment_arear,#bonus,#leave_encasement,#notice_period',
        function() {
