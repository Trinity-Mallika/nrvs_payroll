                ...
                <?php if (isset($_GET['search'])) {   ?>
                    <div class="row">
                        <div class="col-lg-12">
                                    ...
                                    <div class="row g-4 align-items-center">
                                        <div class="col-sm">
                                            <div class="d-flex justify-content-between align-items-center flex-wrap">
                                                ...
                                                <div class="mb-3">
                                                    <a href="<?php echo $pagename; ?>" class="btn btn-primary">
                                                        Search Again
                                                    </a>
                                                </div>
                                            </div>
                            ...
                            <div class="card-body">
                                <?php
                                $employees = $obj->executequery("SELECT e.emp_id,e.department_id,e.is_esic,e.emp_code,e.first_name,e.last_name,e.mobile_no,e.aadhar_no,e.shift_id,
                                                    ...
                                                    WHERE e.unit_id = '$unitid' $crit2 group by e.emp_id
                                                ");
                                        ...
                                        <table id="buttons-datatables" class="table table-sm table-bordered table-hover align-middle display ">
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($employees as $emp) {
                                                    ...
                                                    $allow_weekly_off = $obj->getvalfield("department_master", "allow_weekly_off", "department_id='$department_id'");
                                                    $is_esic = $emp['is_esic'];
                                                    ...
                                                    echo "<td class='text-center'>
                                                                ...
                                                                <i class='ri-add-line text-primary'></i></span>
                                                            </td>";
