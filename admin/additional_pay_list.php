                                    ...
                                    <div class="col-sm">
                                        <div>
                                            <h5 class="card-title mb-0"> <?= $module; ?> <a
                                                    href="additional_pay_master.php"
                                ...
                                <div class="row g-4 align-items-center">
                                    <div class="col-sm">
                                        <div>
                                            ...
                                            <h5 class="card-title mb-0"> <?= $module; ?> <a href="additional_pay_list.php"
                                                ...
                                                <td>
                                                    ...
                                                    <ul class="list-inline hstack gap-2 mb-0">
                                                        ...
                                                        <li class="list-inline-item " data-bs-toggle="tooltip"
                                                            ...
                                                            title="Edit">
                                                            <a href="additional_pay_master.php?<?php echo $tblpkey ?>=<?php echo $row[$tblpkey]; ?>"
                                                                class="edit-item-btn">
