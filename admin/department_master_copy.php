...
if (isset($_POST['submit'])) {
 ...
 $division  = $obj->test_input($_POST['division']);
  $sub_  = $obj->test_input($_POST['sub_']);

    $department_name  = $obj->test_input($_POST['department_name']);
    $c_off_check = isset($_POST['c_off_check']) ? 1 : 0;

    $count = $obj->getvalfield($tblname, "count(*)", "department_name='$department_name' and unit_id='$unitid' and $tblpkey!='$keyvalue'");
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 mb-3 mt-2">
                                            ...
                                            <input type="submit" name="submit" class="btn btn-sm btn-primary add-btn" value="<?php echo $btn_name ?> " onClick="return checkinputmaster('department_name')">
                                    ...
                                    <table id="buttons-datatables" class="display table table-sm table-bordered" style="width:100%">
                                        ...
                                        <tbody><?php
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?= ($row['c_off_check'] == 1) ? 'C-Off Allowed' : 'C-Off Not Allowed' ?>
                                                    </td>
