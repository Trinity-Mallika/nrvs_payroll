...
if (isset($_POST['submit'])) {
    ...
    if ($count > 0) {
        ...
        if ($keyvalue == 0) {
            // $if_exist = $obj->getvalfield("employee_master", "count(*)", "emp_code='$emp_code' and $tblpkey!='$keyvalue'");
            // if ($if_exist > 0) {
            //     $emp_code =  $emp_code = $obj->getcode("employee_master", "emp_code",  "unit_id='$unitid' and $tblpkey!='$keyvalue'");
            // }emp_sign
...
if (isset($_GET[$tblpkey])) {
    ...
    // $emp_code = $obj->getcode("employee_master", "emp_code",  "unit_id='$unitid'");
    $first_name = $last_name = $father_name = $biomatric_id = $gender = $dob = $age = $blood_group = $marital_status =   $religion = $caste = $mobile_no = $alt_mobile_no = $email_id = $present_address = $permanent_address = $emer_contact_name = $emer_contact_relation = $emer_contact_no = $aadhar_no = $pan_no = $driving_license = $passport_no = $identification_masks = $department_id = $designation_id = $grade_id = $date_of_joining =   $shift_id = $employee_type = $reporting_manager = $employer_name = $employer_designation_id = $service_from = $service_to = $reason = $job_responsibility = $last_salary = $profile_image = $emp_sign = $basic_salary = $opening_balance = $opening_date = $hra = $da = $conveyance = $medical_allowance = $special_allowance = $is_pf = $is_esic = $is_pt = $is_lwf = $ctc = $gross_salary = $net_salary =  $pf_uan = $uan_no = $esic_no = $pf_joining_date = $esic_joining_date = $document_ids = $form21_last_date = $emp_code = $last_name = '';
...
<body>
                    ...
                    <form method="post" action="" enctype="multipart/form-data">
                        <div class="col-lg-12">
                            <div class="card" id="customerList">
                                <div class="card-header border-bottom-dashed">
                                    <div class="row g-4 align-items-center">
                                        <div class="col-sm">
                                            <div>
                                                <h5 class="card-title mb-0">Employee Information <a href="emp_list.php" class="float-end btn btn-primary btn-sm">Emp List</a> </h5>
                                            </div>
                                ...
                                <div class="card-body">
                                    <?php if ($keyvalue > 0) { ?>
                                        <div class="col-lg-12 text-center mb-4  ">
                                            <h5 class="card-title  text-primary">Employee Name : <?= $first_name . $last_name . " - " . $emp_code ?> </h5>
                                        </div>
                                    <?php } ?>
                                    <!-- ⭐ TABS BAR (10 Steps) -->
                                    <div class="step-arrow-nav">
                                        <ul class="nav nav-tabs nav-justified mb-4" id="stepTabs">
                                            ...
                                            <li class="nav-item cursor-pointer"><a class="nav-link p-1 fw-bold"
                                                    data-step="7">Bank Details</a></li>
                                            <li class="nav-item cursor-pointer"><a class="nav-link p-1 fw-bold"
                                                    data-step="8">PF/ESIC</a></li>
                                            <li class="nav-item cursor-pointer"><a class="nav-link p-1 fw-bold"
                                                    data-step="9">Documents</a></li>
                                            <li class="nav-item cursor-pointer"><a class="nav-link p-1 fw-bold"
                                                    data-step="10">Language Known</a></li>
                                            <li class="nav-item cursor-pointer"><a class="nav-link p-1 fw-bold"
                                                    data-step="11">Check List</a></li>
                                        </ul>
                                        ...
                                        <div class="form-step form-step-active">
                                            ...
                                            <div class="row g-3">
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <input type="text" class="form-control form-control-sm"
                                                        name="biomatric_id" id="biomatric_id" placeholder="Enter Code" value="<?= $biomatric_id ?>" onkeypress="numberOnly(event);">
                                                </div>
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <script>
                                                        document.getElementById('gender').value = '<?php echo ucfirst(strtolower($gender)); ?>';
                                                    </script>
                                                </div>
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <input type="date" class="form-control form-control-sm"
                                                        name="dob" id="dob" value="<?= $dob ?>" onkeyup="calculateAge()">
                                                </div>

                                                <div class="col-md-3">
                                                    <label class="form-label">Age</label>
                                                    <input type="text" class="form-control form-control-sm"
                                                        name="age" id="age" value="<?= $age ?>" placeholder="Enter Age" autocomplete="off" onkeypress="numberOnly(event);" maxlength="3" readonly>
                                                </div>

                                                <div class="col-md-3">
                                                    <label class="form-label">Blood Group</label>
                                                    <select class="form-select form-select-sm chosen-select" name="blood_group" id="blood_group">
                                                ...
                                                <div class="col-md-3" id="anniversary_div" style="display: none;">
                                                    <label class="form-label" for="anniversary_date">Anniversary Date</label>
                                                    <input type="date" class="form-control form-control-sm"
                                                        name="anniversary_date" id="anniversary_date" value="<?= $anniversary_date ?>">
                                                </div>
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    ?>
                                                        <img src="<?php echo $imgpath1 . $profile_image;  ?>" style="height: 50px;" alt="">
                                                    <?php
                                                    } ?>
                                                </div>
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <?php if ($emp_sign != "") {
                                                    ?>
                                                        <img src="<?php echo $imgpath1 . $emp_sign;  ?>" style="height: 50px;" alt="">
                                                    <?php
                                                    } ?>
                                                </div>
                                            </div>
                                            ...
                                            <div class="mt-4 text-end">
                                                <button type="button" class="btn btn-primary btn-next" data-validate="emp_code,biomatric_id,first_name">Next
                                                    →</button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-step">
                                            ...
                                            <div class="row g-3">
                                                <div class="col-md-3">
                                                    ...
                                                    <input type="text" class="form-control form-control-sm"
                                                        name="mobile_no" id="mobile_no" value="<?= $mobile_no ?>" placeholder="Enter Number" autocomplete="off" onkeypress="numberOnly(event);" maxlength="10" onchange="checkDuplicateMobile(this.value)">
                                                </div>
                                            ...
                                            <div class="mt-4 d-flex justify-content-between">
                                                <button type="button" class="btn btn-secondary btn-prev">←
                                                    Previous</button>
                                                <button type="button" class="btn btn-primary btn-next" data-validate="mobile_no">Next
                                                    →</button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-step">
                                            ...
                                            <div class="row g-3">
                                                <div class="col-md-3">
                                                    ...
                                                    <input type="text" class="form-control form-control-sm"
                                                        name="aadhar_no" id="aadhar_no" value="<?= $aadhar_no ?>" placeholder="Enter Aadhaar Number" onchange="checkDuplicateAadhar(this.value)">
                                                </div>
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio"
                                                            name="is_form21_last_date" id="form21_yes" value="1" <?= $is_form21_last_date == '1' ? 'checked' : '' ?> onclick="toggleForm21Date()">
                                                        <label class="form-check-label" for="form21_yes">Yes</label>
                                                    </div>

                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio"
                                                            name="is_form21_last_date" id="form21_no" value="0" <?= $is_form21_last_date == '0' ? 'checked' : '' ?> onclick="toggleForm21Date()">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <textarea class="form-control form-control-sm"
                                                        ...
                                                        id="identification_masks" rows="1"><?= $identification_masks ?></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="mt-4 d-flex justify-content-between">
                                                <button type="button" class="btn btn-secondary btn-prev">←
                                                    Previous</button>
                                                <button type="button" class="btn btn-primary btn-next" data-validate="aadhar_no">Next
                                                    →</button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-step">
                                            ...
                                            <div class="row g-3">
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <input type="text" class="form-control form-control-sm"
                                                        ...
                                                        value="<?= $basic_salary  ?>" onkeypress="numberOnly(event);" placeholder="Enter Basic Salary">
                                                </div>
                                                <div class="col-md-3">
                                                    ...
                                                    <input type="text" class="form-control form-control-sm"
                                                        ...
                                                        value="<?= $opening_balance  ?>" onkeypress="numberOnly(event);" placeholder="Enter Opening Balance">
                                                </div>
                                                <div class="col-md-3">
                                                ...
                                                <div class="col-lg-3 mb-3">
                                                    <label for="shift_id" class="form-label">Shift Hours<span
                                                            class="text-danger fw-bold">*</span> </label>
                                                    <select class="form-select form-select-sm chosen-select"
                                            ...
                                            <div class="mt-4 d-flex justify-content-between">
                                                <button type="button" class="btn btn-secondary btn-prev">←
                                                    Previous</button>
                                                <button type="button" class="btn btn-primary btn-next" data-validate="basic_salary,department_id,designation_id,date_of_joining,job_location,shift_id">Next
                                                    →</button>
                                                ...
                                                <table class="table table-bordered table-sm">
                                                    <thead class="table-light">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input type="text" class="form-control form-control-sm" id="member_name" placeholder="Enter Member Name"></td>
                                                            <td><input type="text" class="form-control form-control-sm" id="member_relation" placeholder="Enter Member Relation"></td>
                                                            <td><input type="date" class="form-control form-control-sm" id="member_dob"></td>
                                                            <td><input class="form-control form-control-sm" id="member_address" placeholder="Enter Member Address"></td>
                                                            <td>
                                                            ...
                                                            <td>
                                                                <input type="file" class="form-control form-control-sm" id="family_aadhar_card">
                                                            </td>
                                                            ...
                                                            <td class="text-center">
                                                                <div class="d-flex align-items-center wt">
                                                                    <div class="flex-grow-1 ms-2 name">
                                                                        <label class="switch">
                                                                            <input type="checkbox" id="is_nominee" checked>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-bordered table-sm">
                                                    <thead class="table-light">
                                                        ...
                                                        <tr>
                                                            <td><input type="text" class="form-control form-control-sm" id="examination" placeholder="Enter Examination"></td>

                                                            <td><input type="text" class="form-control form-control-sm" id="university" placeholder="Enter Board/University"></td>

                                                            <td><input type="text" class="form-control form-control-sm" id="college" placeholder="Enter College/Institute"></td>

                                                            <td><input type="text" class="form-control form-control-sm" id="pass_year" placeholder="Enter Passing Year" oninput="formatPassingYear(this);"></td>

                                                            <td><input type="text" class="form-control form-control-sm" id="percentage" placeholder="Enter Percentage" onkeypress="numberOnly(event);"></td>

                                                            <td><input type="text" class="form-control form-control-sm" id="subject" placeholder="Enter Subject"></td>

                                                            <td><button type="button" class="btn btn-sm btn-success" onclick="save_emp_education();" id="education_btn">Add</button></td>
                                                        </tr>
                                                    </thead>
                                        ...
                                        <div class="form-step">
                                            <div class="row g-3">
                                                ...
                                                <div class="col-md-6"><label>Job Responsibilities</label><textarea
                                                        class="form-control form-control-sm" rows="1" name="job_responsibility" id="job_responsibility"><?= $job_responsibility ?></textarea>
                                                </div>
                                            </div>
                                                ...
                                                <table class="table table-bordered table-sm">
                                                    <thead class="table-light">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><select class="form-select form-select-sm chosen-select"
                                                            ...
                                                            <td>
                                                                <input type="text" class="form-control form-control-sm" id="acc_holder_name" placeholder="Enter Account Holder Name">
                                                            </td>
                                                            <td>
                                                                <input type="text" class="form-control form-control-sm" id="account_no" placeholder="Enter Account Number">
                                                            </td>
                                                            <td><input class="form-control form-control-sm" id="ifsc_code" placeholder="Enter IFSC Code"></td>
                                                            <td class="text-center">
                                                                <div class="d-flex align-items-center wt">
                                                                    <div class="flex-grow-1 ms-2 name">
                                                                        <label class="switch">
                                                                            <input type="checkbox" id="bank_active" checked>
                                                                            <span class="slider round"> </span>
                                                                        </label>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                            <td><button type="button" class="btn btn-sm btn-success" onclick="save_bank_details();" id="bank_btn">Add</button></td>
                                                        </tr>
                                                    </thead>
                                        ...
                                        <div class="form-step">
                                            <div class="row g-3">
                                                ...
                                                <div class="col-md-2"><label>PF NO.</label><input
                                                        class="form-control form-control-sm" placeholder="Enter PF NO." name="pf_uan" id="pf_uan" value="<?= $pf_uan ?>"></div>
                                                <div class="col-md-2"><label>UAN NO.</label><input
                                                        class="form-control form-control-sm" placeholder="Enter UAN NO." name="uan_no" id="uan_no" value="<?= $uan_no ?>"></div>

                                                <div class="col-md-2"><label>ESIC Number</label><input
                                                        class="form-control form-control-sm" placeholder="Enter ESIC Number" name="esic_no" id="esic_no" value="<?= $esic_no ?>"></div>

                                                <div class="col-md-2"><label>PF Joining Date</label><input
                                                        type="date" class="form-control form-control-sm" placeholder="Enter PF Joining Date" name="pf_joining_date" id="pf_joining_date" value="<?= $pf_joining_date ?>"></div>

                                                <div class="col-md-2"><label>ESIC Joining Date</label><input
                                                        type="date" class="form-control form-control-sm" name="esic_joining_date" id="esic_joining_date" value="<?= $esic_joining_date ?>"></div>
                                            </div>
                                                ...
                                                <table class="table table-bordered table-sm">
                                                    <thead class="table-light">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input type="file" class="form-control form-control-sm" id="doc_file">
                                                            </td>
                                                            <td>
                                                                <input type="date" class="form-control form-control-sm" id="doc_expiry_date">
                                                            </td>
                                                            <td>
                                                                <input type="text" class="form-control form-control-sm" id="doc_remark" placeholder="Enter Remark">
                                                            </td>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-bordered table-sm">
                                                    <thead class="table-light">
                                                        ...
                                                        <tr>
                                                            <td><input type="text" class="form-control form-control-sm" id="language_name" placeholder="Enter Language Name"></td>

                                                            <td>
                                                                <div class="d-flex gap-3">
                                                                    <div class="form-check">
                                                                        <input class="form-check-input" type="radio"
                                                                            name="language_speak" id="language_speak_yes" value="1">
                                                                        <label class="form-check-label" for="language_speak_yes">
                                                                            Yes
                                                                        </label>
                                                                    </div>
                                                                    ...
                                                                    <div class="form-check">
                                                                        <input class="form-check-input" type="radio"
                                                                            name="language_speak" id="language_speak_no" value="0" checked>
                                                                        <label class="form-check-label" for="language_speak_no">
                                                                            No
                                                                        </label>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <td>
                                                                <div class="d-flex gap-3">
                                                                    <div class="form-check">
                                                                        <input class="form-check-input" type="radio"
                                                                            name="language_read" id="language_read_yes" value="1">
                                                                        <label class="form-check-label" for="language_read_yes">
                                                                            Yes
                                                                        </label>
                                                                    </div>
                                                                    ...
                                                                    <div class="form-check">
                                                                        <input class="form-check-input" type="radio"
                                                                            name="language_read" id="language_read_no" value="0" checked>
                                                                        <label class="form-check-label" for="language_read_no">
                                                                            No
                                                                        </label>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <td>
                                                                <div class="d-flex gap-3">
                                                                    <div class="form-check">
                                                                        <input class="form-check-input" type="radio"
                                                                            name="language_write" id="language_write_yes" value="1">
                                                                        <label class="form-check-label" for="language_write_yes">
                                                                            Yes
                                                                        </label>
                                                                    </div>
                                                                    ...
                                                                    <div class="form-check">
                                                                        <input class="form-check-input" type="radio"
                                                                            name="language_write" id="language_write_no" value="0" checked>
                                                                        <label class="form-check-label" for="language_write_no">
                                                                            No
                                                                        </label>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <td><button type="button" class="btn btn-sm btn-success" onclick="save_emp_language();" id="language_btn">Add</button></td>
                                                        </tr>
                                                    </thead>
                                                ...
                                                <table class="offset-3 table table-bordered table-sm w-50 table-light">
                                                    <thead>
                                                        <tr class="table-warning">
                                                            ...
                                                            <th>Check List <span class="text-danger">*</span><input type="checkbox" class="form-check-input" id="checkAllCheckList" /></th>
                                                        </tr>
                                                    </thead>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        ?>
                                                            <tr>
                                                                <td> <b> <?= htmlspecialchars($row['document_name']); ?></b></td>

                                                                <td class="text-center">
                                                                    <input class="form-check-input check_single"
                                                                        type="checkbox"
                                                                        name="document_check_list[]"
                            ...
                            <div class="col-lg-12 mb-3 d-flex justify-content-center gap-2">
                                ...
                                <input type="submit" name="submit" class="btn btn-sm btn-primary add-btn" value="Save" onClick="return validateForm();">
                ...
                success: function(res) {
                    if (res.trim().startsWith('EXISTS')) {
                        ...
                        Swal.fire({
                            ...
                            text: 'This mobile number ' + mobile_no + ' already exists in Unit : ' + unit_name,
                ...
                success: function(res) {
                    if (res.trim().startsWith('EXISTS')) {
                        ...
                        Swal.fire({
                            ...
                            text: 'This Aadhar number ' + aadhar_no + ' already exists in Unit : ' + unit_name,
                            confirmButtonText: 'OK'
                        }).then(() => {
                            $('#aadhar_no').val('').focus();
                        });
    ...
    <script>
        ...
        function validateForm() {
            ...
            const steps = [{
                    tab: 'Basic Info',
                    fields: ['emp_code', 'biomatric_id', 'first_name']
                },
                {
                    tab: 'Contact',
                    fields: ['mobile_no']
                ...
                {
                    tab: 'Job',
                    fields: ['basic_salary', 'department_id', 'designation_id', 'date_of_joining', 'job_location', 'shift_id']
                }
            ];
