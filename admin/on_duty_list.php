...
$pagename = "on_duty_list.php";
$title = "On Duty Master List";
                        ...
                        <div class="card" id="customerList">
                            <div class="card-header border-bottom-dashed">
                                <div class="row g-4 align-items-center">
                                    <div class="col-sm">
                                        <div>
                                            <h5 class="card-title mb-0"> <?= $module; ?><a href="on_duty.php"
...
");
                                ...
                                ">
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="on_duty.php?<?php echo $tblpkey ?>=<?php echo $row[$tblpkey]; ?>"
                                                                class="edit-item-btn">
            ...
            <div class="modal-content shadow">
                ...
                <div class="modal-body">
                    ...
                    <div class="text-center mt-4">
                        <button id="updateOnDutyBtn" class="btn btn-danger px-4" onclick="updateOnDutyStatus();">
                            Update
                        </button>
                    </div>
                    <?php } ?>
    ...
    function updateOnDutyStatus() {
        ...
        $('.detail_row').each(function() {
            ...
            let outtime = $('#modal_outtime_' + id).val();
            let date = $('#modal_date_' + id).val();
            let on_duty_type = $('#modal_on_duty_type_' + id).val();
