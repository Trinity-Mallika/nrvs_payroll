...
$pagename = "esic_excel.php";
$title = "ESIC Excel Upload";
$tblname = "salary_structure";
$tblpkey = "salary_struc_id";
$module = "ESIC Excel Upload";
$submodule = "ESIC Excel Upload List";
$btn_name = "Save";
        ...
        if ($fileType === 'xlsx') {
            if ($xlsx = SimpleXLSX::parse($_FILES['file_upload']['tmp_name'])) {
                foreach ($xlsx->rows() as $k => $data) {
                    ...
                    list($emp_code, $emp_name, $esic_emp) = $data;
                    ...
                    $obj->update_record(
                        'employee_master',
                        ['emp_id' => $emp_id, 'unit_id' => $unitid],
                        ['is_esic' => $is_esic, 'lastupdated' => $createdate]
                    );
                    $insertedCount++;
                }
            }
