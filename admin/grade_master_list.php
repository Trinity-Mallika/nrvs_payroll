...
$pagename = "grade_master_list.php";
$pagename2 = "grade_master.php";
                            ...
                            <div class="card" id="customerList">
                                <div class="card-header border-bottom-dashed">
                                    <div class="row g-4 align-items-center">
                                        <div class="col-sm">
                                            <div>
                                                <h5 class="card-title mb-0"> <?= $submodule; ?><a href="grade_master.php" class="float-end btn btn-primary btn-sm">Add Grade</a></h5>
                                            </div>
                                        </div>
                                    </div>
