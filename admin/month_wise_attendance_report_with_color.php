...
document.getElementById('month').value =
                                        ...
                                        <tbody>
                                            <?php
                                                ...
                                                foreach ($employees as $emp) {
                                                    ...
                                                    for ($d = 1; $d <= $length; $d++) {
                                                       ...
                                                       $date = sprintf('%04d-%02d-%02d', $year, $month, $d);
                                                        ...
                                                        echo "<td style='background:$bg;text-align:center;padding:0' id='cell_{$empId}_{$date}'>
                                                                            ...
                                                                            onclick=\"openPunchModal('$date','$intime','$remark','{$emp['shift_id']}','$shift','$month','$year','$empId','$salaryCount','{$extra_off['balance']}','{$total_earning_leave}','{$prev_coff}')\">
                                                                            <b>$txt</b>
                                                                            </span>
                                                                        </td>";
                                                    } 
                                                   ...
                                                   echo "<td class='text-center fw-bold text-dark' style='background:#88bef7'>" 
    ...
    function openPunchModal(attdate, time, remark, emp_shift_hrs, empp_shift_id, month, year, emp_id,
        salary_generate_count, extraOffBalance, total_earning_leave,coff_balance) {
    ...
    function add_all_att(emp_shift_hrs, empp_shift_id, month, year, emp_id, salary_generate_count, extraOffBalance,
        total_earning_leave,coff_balance) {
