...
if ($_SERVER['REQUEST_METHOD'] == 'POST') { 
    $detailCount = $obj->getvalfield(
        ...
        "on_duty_id='$keyvalue' and unit_id='$unitid' and emp_id='$emp_id' and leave_type='EO'"
    );
        ...
        success: function(res) {
            ...
            if (res.status == 'success') {
                Swal.fire({
                    ...
                    window.location.href = 'leave_apply_list.php?type=EO';
                });
...
function fetch_leave_details() {
    ...
    jQuery.ajax({
        ...
        data: 'keyvalue=' + keyvalue + '&type=EO',
        dataType: 'html',
