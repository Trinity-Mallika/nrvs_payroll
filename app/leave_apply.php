...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // $substitute_emp_id = $obj->test_input($_POST['substitute_emp_id']);
            ...
            <form method="POST" id="gatepassForm" enctype="multipart/form-data">
                <div class="card border-0 shadow-lg mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control shadow-sm" id="emp_name" name="emp_name" value="<?= $emp_name ?>" readonly>
                    </div>
                    <div class="mb-3">
                        <label for="" class="form-label">Mobile No</label>
                        <input type="text" class="form-control shadow-sm" id="contact_no" name="contact_no" value="<?= $mobile_no ?>" readonly>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="row text-center">
                        ...
                        <div class="col-6">
                            <div class="p-3 rounded bg-light shadow-sm">
                                <div class="fw-bold text-primary" style="font-size:18px;" id="earning_leave"><?= $total_earning_leave  ?></div>
                                <small class="text-muted">Earning Leave</small>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="p-3 rounded bg-light shadow-sm">
                ...
                <div class="card border-0 shadow-lg mb-3">
                    <div class="row">
                        <div class="mb-3 col-6">
                            ...
                            <input type="date" class="form-control shadow-sm" id="date" name="date" value="<?= date('Y-m-d') ?>">
                        </div>
                        <div class="mb-3 col-6">
                            <label for="" class="form-label">No. Of Days</label>
                            <input type="number" class="form-control shadow-sm" id="no_of_days" name="no_of_days" value="1">
                        </div>
                        <div class="mb-3 col-6">
                            <label for="" class="form-label">Day</label>
                            <select class="form-control" id="leave_day">
                        ...
                        <div class="mb-3 col-12">
                            ...
                            <input type="hidden" class="form-control shadow-sm" id="leave_details_id" name="leave_details_id" value="0">
                        </div>
                    </div>
