...
if ($_SERVER['REQUEST_METHOD'] == 'POST') { 
    $detailCount = $obj->getvalfield(
        ...
        "on_duty_id='$keyvalue' and unit_id='$unitid' and emp_id='$emp_id' and leave_type='CO'"
    );
        ...
        success: function(res) {
            ...
            if (res.status == 'success') {
                Swal.fire({
                    ...
                    window.location.href = 'leave_apply_list.php?type=CO';
                });
...
function fetch_leave_details() {
    ...
    jQuery.ajax({
        ...
        data: 'keyvalue=' + keyvalue + '&type=CO',
        dataType: 'html',
