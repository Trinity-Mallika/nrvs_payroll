...
// $edit_id = isset($_POST['edit_id']) ? $obj->test_input($_POST['edit_id']) : '';
...
//         "on_duty_details",
//         "count(*)",
//         "on_duty_id='$keyvalue' and createdby='$emp_id' AND unit_id='$unitid'"
//     );
...
$count = $obj->getvalfield("on_duty_details", "count(*)", "on_duty_id='$keyvalue' and unit_id='$unitid' and createdby='$emp_id'");
