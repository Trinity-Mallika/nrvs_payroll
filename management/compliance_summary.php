                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td class="text-end"><?= number_format($row['pf_paid_basic'], 2) ?></td>
                                                        <td class="text-end"><?= number_format($row['pf_emp'], 2) ?></td>
                                                        <td class="text-end"><?= number_format($row['pf_employer'], 2) ?></td>
                                                        <td class="text-end"><?= number_format($row['esic_emp'], 2) ?></td>
                                                        <td class="text-end"><?= number_format($row['esic_employer'], 2) ?></td>
                                                    </tr>
                                                    </tr>
                                                <?php } ?>
                                            </tbody>
