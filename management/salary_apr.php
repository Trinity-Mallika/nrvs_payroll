...
$title = "Salary Approval Report";
$tblname = "salary_structure";
$tblpkey = "salary_struc_id";
$module = "Salary Approval Report";
$submodule = "Salary Approval Report";
$btn_name = "Save";
$crit = " and 1=1";
...
<body>
                        ...
                        <div class="card" id="customerList">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-2 d-flex justify-content-between align-items-center">
                                    <div>
                                        <button class="btn btn-primary btn-sm" onclick="lockAll(1)">
                                            Approve All
                                        </button>
                                        </button> <button class="btn btn-primary btn-sm" onclick="lockAll(0)">
                                            Un-Approve All
                                        </button>
                                    </div>
                                        ...
                                        <table id="buttons-datatables"
                                            ...
                                            <tbody>
                                                ...
                                                <tr id="tr_<?= $row["salary_struc_id"]; ?>" data-details="
                                                                ...
                                                                ">
                                                    <td class="details-control text-center" style="cursor:pointer;" onclick="showActivityLog('<?= $row['salary_struc_id'] ?>', 'salary','salary_structure','salary_struc_id');">
                                                        <?= $slno++; ?>  
                                            ...
                                            <tfoot class="table-light">
                                                <tr>
                                                    ...
                                                    <th class="text-end"><?= number_format($total_month_gross, 2); ?>
                                                    </th>
    ...
    <?php include("activity_log_modal.php"); ?>
    <script>
                ...
                "csv",
                {
                    ...
                    customizeData: function(data) {
                        ...
                        data.body.unshift([
                            ...
                            '<?= $total_add_amt ?>',
                            '<?= number_format($total_month_gross, 2) ?>',
                            '<?= $total_pf ?>',
                            '<?= $total_esic ?>',
                            '<?= $total_advance_amt ?>',
                            '<?= $total_loan_amt ?>',
    ...
    function lockAll(status) {
        let selected = [];
        let text = (status == "1") ? "Approve" : "Un-Approve";
        ...
        Swal.fire({
            title: 'Approve Selected Salaries?',
            text: `Selected salary records will be ${text}d .`,
            icon: 'warning',
            showCancelButton: true,
            ...
            if (result.isConfirmed) {
                ...
                Swal.fire({
                    title: 'Processing....',
                    text: `Please wait while records are being ${text}d.`,
                    ...
                    success: function(response) { 
                        if (response.trim() === "success") {
                            Swal.fire({
                                ...
                                text: `Selected salary records have been ${text}d.`
                            }).then(() => {
                                location.reload();
                            });
