...
function PopupCenter(pageURL, title, w, h) {
  ...
  var targetWin = window.open(
    pageURL,
    title,
    "toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=no, resizable=no, copyhistory=no, titlebar=no, width=" +
      w +
      ", height=" +
      h +
      ", top=" +
...
function showdiv() {
  ...
  $("#divmsg")
    .animate({ backgroundColor: "#FFF2DF" }, 300)
...
function hidediv() {
  ...
  $("#divmsg")
    .animate({ backgroundColor: "#FEBAA7" }, 300)
