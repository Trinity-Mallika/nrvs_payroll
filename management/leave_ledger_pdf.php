...
$footerHeight = 40;
$crit = '';
$unit_imgpath = __DIR__ . '/uploaded/emp_documents/';
...
$empRes = $obj->executequery("SELECT * FROM employee_master WHERE unit_id = '$unit_id' AND (resign_status != '1' OR (resign_status = '1' AND last_working_date >= CURDATE())) $crit ORDER BY first_name ASC");
...
<body>
    <div class="container">
        ...
        <?php foreach ($empRes as $emp) {
            $emp_id = $emp['emp_id'];
            $whereCredit = "emp_id='$emp_id' AND unit_id='$unit_id'";
