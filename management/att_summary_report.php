                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    $employees = $obj->executequery("SELECT e.emp_id,e.unit_id,e.department_id,e.is_esic,e.emp_code,e.first_name,e.last_name,e.mobile_no,e.aadhar_no,e.shift_id,um.unit_name,
                                            ...
                                            <table id="buttons-datatables" class="table table-sm table-bordered table-hover align-middle display ">
                                                ...
                                                <tbody>
                                                    ...
                                                    foreach ($employees as $emp) {
                                                        ...
                                                        $allow_weekly_off = $obj->getvalfield("department_master", "allow_weekly_off", "department_id='$depart_id'");
                                                        ...
                                                        $absent = $effectiveDays - $real_total_att;
                                                        if ($absent < 0) {
                                                            $absent = 0;
                                                        }
                                                        ...
                                                        echo "<td class='text-center fw-bold'>" . number_format($leave_att, 1) . "</td>";
                                                        ...
                                                        echo "<td class='text-center fw-bold'>" . number_format($holiday) . "</td>";
                                                ...
                                                <tfoot>
                                                    <tr style="font-weight:bold;background:#f5f5f5;">
                                                        <td colspan=" <?= count($showFields) + 3 ?> " class="text-end">TOTAL</td>
                                                        <td class="text-center"><?= number_format($total_present, 1) ?></td>
                                                        <td class="text-center"><?= number_format($total_halfday, 1) ?></td>
                                                        <td class="text-center"><?= number_format($total_leave, 1) ?></td>
                                                        <td class="text-center"><?= number_format($total_absent, 1) ?></td>

                                                        <td class="text-center fw-bold"><?= $total_late_in ?></td>
                                                        <td class="text-center fw-bold"><?= $total_early_out ?></td>
                                                        <td class="text-center fw-bold"><?= number_format($total_holiday) ?></td>

                                                        <td class="text-center"><?= number_format($total_week_leave, 1) ?></td>
                                                        <td class="text-center"><?= number_format($total_used_weekly, 1) ?></td>

                                                        <td class="text-center"><?= number_format($total_monthly_leave, 1) ?></td>
                                                        <td class="text-center"><?= number_format($total_used_monthly, 1) ?></td>

                                                        <td class="text-center"><?= number_format($total_coff, 1) ?></td>
                                                        <td class="text-center"><?= number_format($total_used_coff, 1) ?></td>

                                                        <td class="text-center"><?= number_format($total_payable, 1) ?></td>
                                                    </tr>
                                                </tfoot>
                                            </table>
                                        </div>
