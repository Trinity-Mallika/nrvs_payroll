...
$pagename = "depart_manpower_details.php";
$title = "Department Wise Manpower Details";
$tblname = "employee_master";
$tblpkey = "emp_id";
$module = "Department Wise Manpower Details";
$submodule = "Department Wise Manpower Details List";
$btn_name = "Save";
...
if (isset($_GET['employee_type'])) {
    $employee_type = $obj->test_input($_GET['employee_type']);
    if ($employee_type != '') {
        $crit .= " and em.employee_type='$employee_type'";
    }
} else {
    $employee_type = "";
};
...
$fieldMap = [
    ...
    25 => ['label' => 'Opening Leave Date',        'key' => 'opening_date'],
    26 => ['label' => 'Grade',        'key' => 'grade_id'],
    27 => ['label' => 'Department',        'key' => 'department_id'],
    28 => ['label' => 'Designation',        'key' => 'designation_id'],
    29 => ['label' => 'Date of Joining',        'key' => 'date_of_joining'],
    30 => ['label' => 'Job Location',        'key' => 'job_location'],
    31 => ['label' => 'Shift Hours',        'key' => 'shift_id'],
    32 => ['label' => 'Reporting Manager',        'key' => 'reporting_manager'],
    33 => ['label' => 'Employment Type',        'key' => 'employee_type'],
    34 => ['label' => 'Employer Name',        'key' => 'employer_name'],
    35 => ['label' => 'Employer Designation',        'key' => 'employer_designation_id'],
    36 => ['label' => 'Service Period From',        'key' => 'service_from'],
    37 => ['label' => 'Service Period To',        'key' => 'service_to'],
    38 => ['label' => 'Last Drawn Salary',        'key' => 'last_salary'],
    39 => ['label' => 'Reason for Leaving',        'key' => 'reason'],
    40 => ['label' => 'Job Responsibilities',        'key' => 'job_responsibility'],
    41 => ['label' => 'Is PF',        'key' => 'is_pf'],
    42 => ['label' => 'Is ESI',        'key' => 'is_esic'],
    43 => ['label' => 'PF NO.',        'key' => 'pf_uan'],
    44 => ['label' => 'UAN NO.',        'key' => 'uan_no'],
    45 => ['label' => 'ESIC Number',        'key' => 'esic_no'],
    46 => ['label' => 'PF Joining Date',        'key' => 'pf_joining_date'],
    47 => ['label' => 'ESIC Joining Date',        'key' => 'esic_joining_date'],
                                ...
                                <form method="get">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3 mt-4">
                                            <input type="submit" name="submit" class="btn btn-primary add-btn" value="Search" onclick="return checkinputmaster('unit_id,department_id')">
                            ...
                            <div class="card" id="customerList">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive">
                                        <h5 class="text-primary">Total Manpower : <?= $count_res ?></h5>
