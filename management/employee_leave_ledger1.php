                                ...
                                <div class="card-body">
                                    ...
                                    <div class="auto-scroll-wrapper">
                                        <div class="table-responsive">
                                            <?php
                                                $opening_balance = $obj->getOpeningBalance2( 
                                                    $emp_id,
                                                    $leave_type,
                                                    $month,
                                                    $year,
                                                ...
                                                $closing_balance =  $obj->getClosingBalance2( 
                                                    $emp_id,
                                                    $leave_type,
                                                    $month,
                                                    $year,
                                                ...
                                                if($month!=''){
                                                    $openingDate = date(
                                                        'M Y',
                                                        strtotime("$year-".str_pad($month,2,'0',STR_PAD_LEFT)."-01")
                                                    );
                                                     $sortDate = date(
                                                        'Y-m-d',
                                                        strtotime("$year-".sprintf("%02d",$month)."-01 -1 day")
                                                    );
                                                }else{
                                                    $openingDate = "Dec ".($year-1);
                                                    ...
                                                    $transDate = ($row['is_opb'] == 1)
                                                        ...
                                                        if($row['leave_type']=='earning_ded'){
                                                            ...
                                                            $ledger[]=[
                                                                ...
                                                                'leave_type'=>'earning',
                                                                'particular'=> !empty($row['remark']) ? $row['remark'] : 'Leave Deduction',
                                                                'remark' => $row['remark']??'',
                                                                'credit'=>0,
                                                            ...
                                                            $ledger[]=[
                                                                ...
                                                                'remark' => $row['remark']??'',
                                                                'particular'=>($row['is_opb']==1 ? 'Opening Balance' : 'Leave       Credit'),
                                                ...
                                                switch($row['attendance_status']){
                                                    ...
                                                    case 'Extra Off':
                                                        $type='eoff';
                                                        $particular = 'Extra Off Availed (Attendance)';
                                                        $debit=1;
                                                        break;

                                                    case 'Half Extra Off':
                                                        $type='eoff';
                                                        $particular = 'Half Extra Off Availed (Attendance)';
                                                        $debit=0.5;
                                                        break;

                                                    case 'C Off':
                                                        $type='weekly';
                                                        $particular = 'C Off Availed (Attendance)';
                                                        $debit=1;
                                                        break;

                                                    case 'Half C Off':
                                                        $type='weekly';
                                                        $particular = 'Half C Off Availed (Attendance)';
                                                        $debit=0.5;
                                                        break;
                                                    ...
                                                    case 'Earning Leave':
                                                        $type='earning';
                                                        $particular = 'Leave Deduction (Attendance)';
                                                        $debit=1;
                                                        break;
                                                    ...
                                                    case 'Half Earning Leave':
                                                        $type='earning';
                                                        $particular = 'Half Leave Deduction (Attendance)';
                                                        $debit=0.5;
                                                        break;
                                                }
