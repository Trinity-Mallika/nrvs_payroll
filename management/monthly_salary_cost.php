                                        ...
                                        <table id="buttons-datatables" class="display table table-sm table-bordered" style="width:100%">
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        <td><?php echo $slno++; ?>
                                                            <a
                                                                href='monthly_salary_cost_details.php?unit_id=<?= $unit_id ?>&department_id=<?= $row['department_id'] ?>&month=<?= $month ?>&year=<?= $year ?>&submit=Search'>
                                            ...
                                            <tfoot>
                                                <tr style="font-weight:bold;background:#f1f1f1;">
                                                    ...
                                                    <td class="text-end"><?= $gt_employee ?></td>
                                                    <td class="text-end"><?= $gt_basic_salary ?></td>
                                                    <td class="text-end"><?= $gt_basic_da ?></td>
                                                    <td class="text-end"><?= $gt_medical ?></td>
                                                    <td class="text-end"><?= $gt_hra ?></td>
                                                    <td class="text-end"><?= $gt_special ?></td>
                                                    <td class="text-end"><?= $gt_allowance ?></td>

                                                    <td></td>
                                                    <td></td>

                                                    <td class="text-end"><?= $gt_pf_emp ?></td>
                                                    <td class="text-end"><?= $gt_esic_emp ?></td>
                                                    <td class="text-end"><?= $gt_pf_employer ?></td>
                                                    <td class="text-end"><?= $gt_esic_employer ?></td>

                                                    <td class="text-end"><?= $gt_net_salary ?></td>
                                                    <td class="text-end"><?= $gt_additional ?></td>
                                                    <td class="text-end"><?= $gt_other_ded ?></td>
                                                    <td class="text-end"><?= $gt_pay_after_ded ?></td>
