...
if (isset($_POST['submit'])) {
    ...
    $count = $obj->getvalfield(
        $tblname,
        "count(*)",
        "username='$username' AND $tblpkey!='$old_uid'"
    ); 
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="mb-3 col-12 col-lg-3">
                                            <label for="bill_no" class="form-label"> User Type<span
                                                    class="text-danger fw-bold">*</span></label>
                                            <select class="form-control form-control-sm chosen-select" name="usertype1"
                                                id="usertype1"
                                                onchange="toggleUnitField();get_user_details(this.value);">
                                        ...
                                        <div class="mb-3 col-12 col-lg-3" id="unit_id_div">
                                            <label for="bill_no" class="form-label">Unit Name<span
                                                    class="text-danger fw-bold">*</span></label>
                                            <select class="form-select form-select-sm chosen-select" name="unit_id[]"
                                                id="unit_id" multiple>
                                                <?php
                                                $slno = 1;
                                        ...
                                        <div class="col-lg-3 mb-3">
                                            ...
                                            <input type="text" id="fullname" name="fullname"
                                                ...
                                                value="<?php echo $fullname ?>" autocomplete="off" />
                                        </div>
                                        <div class="col-lg-3 mb-3">
                                            ...
                                            <input type="text" id="mobile" name="mobile"
                                                ...
                                                value="<?php echo $mobile ?>" onkeypress="numberOnly(event)"
                                                autocomplete="off" maxlength="10" />
                                        </div>
                                        <div class="mb-3 col-12 col-lg-3">
                                            <label for="enable" class="form-label">Status<span
                                                    class="text-danger fw-bold">*</span></label>
                                            <select class="form-control form-control-sm chosen-select" name="status1"
                                                id="status1">
                                        ...
                                        <div class="col-md-3" id="privilage_div">
                                            <strong> <label for="pri_userid">Privilege From User<span
                                                        class="text-danger fw-bold"> </span></label></strong>
                                            <div class="input-group mb-3">
                                                <select name="pri_userid" id="pri_userid"
                                                ...
                                                <td>
                                                    ...
                                                    <ul class="list-inline hstack gap-2 mb-0">
                                                        ...
                                                        <li class="list-inline-item" data-bs-toggle="tooltip"
                                                            ...
                                                            <a href="<?php echo $pagename ?>?<?php echo $tblpkey ?>=<?php echo $row['userid']; ?>&type=copy"
                                                                class="edit-item-btn">
                                                                <i
                                                                    class="ri-file-copy-fill align-bottom text-primary"></i>
                                                            </a>
                                                        </li>
                                                        ...
                                                        <li class="list-inline-item " data-bs-toggle="tooltip"
                                                            data-bs-trigger="hover" data-bs-placement="top"
                                                            title="Edit">
                                                            <a href="<?php echo $pagename ?>?<?php echo $tblpkey ?>=<?php echo $row['userid']; ?>"
                                                        ...
                                                        <li class="list-inline-item" data-bs-toggle="tooltip"
                                                            ...
                                                            <a class="remove-item-btn" type="button"
                                                                onclick="funDel(<?php echo $row['userid']; ?>);">
                                                                <i
