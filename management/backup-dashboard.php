...
$today_dob = $obj->getvalfield(
    "employee_master",
    "COUNT(*)",
    "DAY(dob) = DAY(CURDATE()) AND MONTH(dob) = MONTH(CURDATE()) AND unit_id='$header_unit_id'"
);

$today_anny = $obj->getvalfield(
    "employee_master",
    "COUNT(*)",
    "DAY(anniversary_date) = DAY(CURDATE()) AND MONTH(anniversary_date) = MONTH(CURDATE()) AND unit_id='$header_unit_id'"
);

$work_anny = $obj->getvalfield(
    "employee_master",
    "COUNT(*)",
    "DAY(date_of_joining) = DAY(CURDATE()) AND MONTH(date_of_joining) = MONTH(CURDATE()) AND unit_id='$header_unit_id'"
);
...
$sixty_plus_emp = $obj->getvalfield(
    ...
    "unit_id='$header_unit_id' 
     AND TIMESTAMPDIFF(YEAR, dob, CURDATE()) >= 60 AND unit_id='$header_unit_id'"
);

$todayin = $obj->getvalfield("attendance_entry", "count(*)", "attendance_status IN ('Present','Half Day','Weekly Leave','Earning Leave','Incomplete') and attendance_date='$datecurrent' and sessionid='$header_session_id' AND unit_id='$header_unit_id'");

$today_leave = $obj->getvalfield("attendance_entry", "count(*)", "attendance_status ='Leave' and attendance_date='$datecurrent' and sessionid='$header_session_id' AND unit_id='$header_unit_id'");
...
$total_pf_emp = $obj->getvalfield("salary_structure", "SUM(pf_employer)", "unit_id='$header_unit_id' AND sessionid='$header_session_id'");
$total_esic_emp = $obj->getvalfield("salary_structure", "SUM(esic_employer)", "unit_id='$header_unit_id' AND sessionid='$header_session_id'");
$last_month_salary = $obj->getvalfield("salary_structure", "SUM(total_pay_sal_after_ded)", "unit_id='$header_unit_id' AND month='$lastMonth' AND year='$currentYear' and sessionid='$header_session_id'") ?? 0;
            ...
            <div class="page-content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row g-4 mb-4">
                        ...
                        <div class="col-xl-3 col-md-6 mt-0">
                            <!-- card -->
                            <a class="card" href="employee_report.php?anniversary_date=<?= $datecurrent; ?>&submit=Search">
                                <div class="card-header text-center bg-primary ">
                        ...
                        <div class="col-xl-3 col-md-6 mt-0">
                            <!-- card -->
                            <a class="card" href="employee_report.php?work_anniversary=<?= $datecurrent; ?>&submit=Search">
                                <div class="card-header text-center bg-primary ">
                            ...
                            <div class="table-responsive">
                                <table id="buttons-datatables" class="display table table-sm table-bordered" style="width:100%">
                                    ...
                                    <tbody>
                                        <?php
                                        $sno = 1;
                                        $res = $obj->executequery("SELECT ae.*, em.first_name, em.last_name,em.emp_code FROM attendance_entry ae LEFT JOIN employee_master em ON ae.emp_id = em.emp_id WHERE ae.unit_id = '$header_unit_id' and ae.attendance_status IN ('Present', 'Incomplete','Half Day') and ae.attendance_date = '$datecurrent' ORDER BY ae.attendance_id DESC");
