...
//$inputJSON = '{"EmployeeID":"4018","SerialNo":"6728322120001025","AttendanceDate":"2026-04-03","PunchTime":"2026-04-03T05:00:31"}';
...
LIMIT 1;";
			...
			if ($emp_id > 0) {
				...
				// 	"attendance_log",
				// 	"attendance_log_id",
				// 	"emp_id='$emp_id' AND attendance_date='$attendance_date' ORDER BY attendance_log_id DESC LIMIT 1"
				// );
				...
				$last_shift_id_entry = $obj->getvalfield("attendance_entry", "shift_id", "attendance_id='$last_entry_id'") ?? $shift_id;
				...
				if ($open_log_id == "") {
					...
					$log_data = array(
						'emp_id' => $emp_id,
						'shift_id' => $last_shift_id_entry ?? $shift_id,
						'department_id' => $department_id,
						'machine_userid' => $machine_userid,
						'intime' => $attendance_time,
						'attendance_stamp' => $attendance_stamp,
