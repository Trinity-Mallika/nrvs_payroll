...
//$inputJSON = '{"EmployeeID":"1144","SerialNo":"6728422090000160","AttendanceDate":"2026-03-01","PunchTime":"2026-03-01T19:10:35"}';

//$inputJSON2 = '{"EmployeeID":"3589","DeviceID":"6728322120001144","AttendanceDate":"2026-02-28","PunchTime":"2026-02-28 09:15:47"}';
...
if ($inputJSON != "") {
	...
	foreach ($data as $value) {
		...
		if ($machine_userid != '') {
			...
			$sql = "SELECT shift_id, in_time, out_time, is_cross_day,
        grace_time_in, grace_time_out
        FROM shift_master
        WHERE unit_id = '$unit_id'
        AND working_hour = '$Office_working_hour'
        AND (
            (is_cross_day = 0 AND 
                '$attendance_time' BETWEEN in_time AND out_time)
